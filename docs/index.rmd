---
title: "How has the COVID-19 pandemic influenced winter antidepressant prescribing patterns across Scottish health boards, and does this vary by socioeconomic deprivation? 3" 
output: 
  html_document:
    theme: lumen
    code-fold: true 
...
interactive_plot <- ggplotly(plot,tooltip="text",height=250) #convert ggplot to interactive plotly object with tooltips
interactive_plot
```
<!-- Button to open fullscreen modal --> <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#figure1Modal"> See Figure 1 in Full Screen </button> <!-- Modal --> <div class="modal fade" id="figure1Modal" tabindex="-1"> <div class="modal-dialog modal-dialog-centered p-8" style="max-width: 95%"> <div class="modal-content p-4"> # Render the same interactive plot inside the modal interactive_plot </div> </div> </div> 
...
*Figure 2*
```{r figure2, message=FALSE, warning=FALSE,eval=TRUE}
#| fig-align: center
#| fig-width: 4
#| fig_height: 4
...
interactive_map <- girafe(ggobj = plot_map, width_svg = 4, height_svg = 4)
interactive_map
```
