---
title: "How has the COVID-19 pandemic influenced winter antidepressant prescribing patterns across Scottish health boards, and does this vary by socioeconomic deprivation? 2" 
output: 
  html_document:
    theme: lumen
    code-fold: true 
...
interactive_map <- girafe(ggobj = plot_map)
interactive_map
```
...
*** 
**Conclusion**
This analysis shows that antidepressant prescribing increased across almost all Scottish health boards after COVID-19, with the largest rises seen in Glasgow and Lanarkshire. However, average SIMD quintile did not explain these differences, as no clear deprivation gradient appeared before or after the pandemic Figure 3.
